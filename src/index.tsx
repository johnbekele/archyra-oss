/**
 * @fileoverview Entry point for archyra package
 *
 * Archyra - Beautiful animated components for React/Next.js applications
 * including loading states, e-commerce interactions, and chat UIs.
 *
 * @package archyra
 * @version 1.0.0
 *
 * @example
 * // Import default component (AiCreating)
 * import AiCreating from 'archyra';
 *
 * @example
 * // Import named components
 * import { AiCreating, AiCreating2, ProductCard, AddToCartButton } from 'archyra';
 */
